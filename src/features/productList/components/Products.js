...
const WebFilter = ({ filters, handleFilter }) => {
  return (
                  ...
                  {section.options.map((option, optionIdx) => (
                    <div key={option.value} className="flex items-center">
                      <input
                        ...
                        className="cursor-pointe rh-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label
            ...
            {products.map((product) => (
              ...
              >
                <div className="group relative border-solid border-2 border-gray-200 p-3 rounded">
                  ...
                  {product.stock <= 0 && (
                    <p className="text-small text-red-400">Out Of Stock</p>
                  )}
                </div>
              </Link>
            ))}
