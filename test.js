...
const newProducts = [...products.filter(item => item.category !== 'womens dresses')]


// console.log(brands)
let it = new Set([...newProducts.map(item => item.brand)])


// let newCt = brands.map(c=> ({value:c, label:c.split('-').join(' '), checked:false}))
